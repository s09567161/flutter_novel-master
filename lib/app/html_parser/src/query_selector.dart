...
class SelectorEvaluator extends Visitor {
  ...
  bool visitPseudoClassSelector(PseudoClassSelector selector) {
    switch (selector.name) {
      ...
      case 'root':
        //  fix when we have a .ownerDocument pointer
  ...
  bool visitPseudoClassFunctionSelector(PseudoClassFunctionSelector selector) {
    switch (selector.name) {
      ...
      case 'lang':
        //  shouldn't need to get the raw text here, but csslib
        ...
        //  implement wildcards in level 4
  ...
  //  negation should support any selectors in level 4,
